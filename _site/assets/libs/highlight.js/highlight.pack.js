...
begin:/^\.\.\.(?=[ ]|$)/}]}]})})());hljs.registerLanguage("latex",(()=>{"use strict";return e=>{const n=[{
...
subLanguage:"bash"}}]})})());hljs.registerLanguage("julia",(()=>{"use strict";return e=>{
...
begin:'""'}],starts:a
},e.COMMENT("^\\s*%\\{\\s*$","^\\s*%\\}\\s*$"),e.COMMENT("%","$")]}}})());hljs.registerLanguage("plaintext",(()=>{"use strict";return t=>({
