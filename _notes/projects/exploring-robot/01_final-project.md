...
{% include built-in/3-img.html id="1"
    url1="/assets/images/randomdots.png" caption1="Random Dots Map" 
    url2="/assets/images/TheOffice.png" caption2="The Office Map" 
    url3="/assets/images/maze.png" caption3="The Maze Map" 
%}
